...
const navigation = [
  ...
  { name: 'Transfer senden', href: '/transfer-senden', icon: IconFileText },
  { name: 'Transfers', href: '/transfers', icon: IconFileText },
  { name: 'Empfänger', href: '/empfaenger', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Transfer senden', href: '/gateway/apps/69bd62b274a02ce2c0b4b8d0?template=list_page', icon: IconFileText },
  { name: 'Transfers', href: '/gateway/apps/69bd62b7b7f518cc6d7d58c1?template=list_page', icon: IconFileText },
  { name: 'Empfänger', href: '/gateway/apps/69bd62b911d360b744ad78cb?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69bd62b274a02ce2c0b4b8d0?template=list_page"
